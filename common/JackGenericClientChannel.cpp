...
void JackGenericClientChannel::ClientOpen(const char* name, int pid, int origlen, int uuid, int* shared_engine, int* shared_client, int* shared_graph, int* result)
{
    JackClientOpenRequest req(name, pid, origlen, uuid);
